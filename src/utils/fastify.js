 ...
 * - If the API key provided in the request matches the expected key.
...
export const isValidRequest = (request, allowedDomains) => {
	// Retrieve API key from headers or params
	const apiKey =
		request.headers?.['x-filebuds-apikey'] || request.params?.['apikey'];
